			...
			<c:forEach var="cartItem" items="${sessionScope.cart.cartItems}">
				<tr class="bg">
                    ...
                    <td>
                        ...
                        <input type="text" class="quantity" id="${cartItem.item.itemId}"  name="${cartItem.item.itemId}" value="${cartItem.quantity}">
                        <div id="cartMsg"></div>
                    ...
                    <td>
                        ...
                        <label id="total${cartItem.item.itemId}">${cartItem.total}</label>
                        <!--
